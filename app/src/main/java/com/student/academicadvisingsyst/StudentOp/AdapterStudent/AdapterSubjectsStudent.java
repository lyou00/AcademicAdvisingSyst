...
public class AdapterSubjectsStudent extends RecyclerView.Adapter<AdapterSubjectsStudent.ViewHolder> {
    private List<Subjects>mylists;
   // private ProductFragment productFragment;
   // private ProductPageByCategoryFragment productPageByCategoryFragment;
    private Context activity;

    public AdapterSubjectsStudent(List<Subjects> mylists) {
        this.mylists = mylists;
    }

    public AdapterSubjectsStudent(List<Subjects> mylists, Context activity) {
        this.mylists = mylists;
    ...
    int ac=0;
    long fileid;
    public AdapterSubjectsStudent(List<Subjects> mylists, Context activity, int act) {
        this.mylists = mylists;
        this.activity = activity;
        this.ac=act;
    }
    public AdapterSubjectsStudent(List<Subjects> mylists, Context activity, int act,long fileid) {
        this.mylists = mylists;
        this.activity = activity;
        this.ac=act;
        this.fileid=fileid;
    ...
    @NonNull
    @Override
    public AdapterSubjectsStudent.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view;
        if (viewType == VIEW_TYPE_EMPTY){
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.empty_data, parent, false);
        } else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.subjectliststudent,parent,false);
        }
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterSubjectsStudent.ViewHolder holder, int position) {
        if (!mylists.isEmpty()) {
            ...
            holder.btview.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(activity, SectionViewStudent.class);
