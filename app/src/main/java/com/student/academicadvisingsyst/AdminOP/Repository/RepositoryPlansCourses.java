...
public class RepositoryPlansCourses {

    private static RepositoryPlansCourses Instance;
    //    private ArrayList<User> dataSet =new ArrayList<User>();
    public static RepositoryPlansCourses getInstance(){
        if(Instance == null){
            Instance = new RepositoryPlansCourses();
        }
        return Instance;
    }
