...
import com.student.academicadvisingsyst.AdminOP.View.ViewStudentLader;
import com.student.academicadvisingsyst.R;

import java.util.List;

public class AdapterLader extends RecyclerView.Adapter<AdapterLader.ViewHolder> {
   ...
   // private ProductPageByCategoryFragment productPageByCategoryFragment;
    ...
    int type=0;
    public AdapterLader(List<Techars> mylists) {
        this.mylists = mylists;
    }

    public AdapterLader(List<Techars> mylists, Context activity, int type) {
        this.mylists = mylists;
    ...
    @NonNull
    @Override
    public AdapterLader.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_EMPTY){
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.liststu_lader,parent,false);
        }
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterLader.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        if (!mylists.isEmpty()){
            ...
            holder.btviewfilestudent.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(activity, ViewStudentLader.class);
                    intent.putExtra("Id",mylists.get(position).getTecharId());
                    Toast.makeText(activity, ""+mylists.get(position).getTecharId(), Toast.LENGTH_SHORT).show();
                    intent.putExtra("type","مدرب");
                    intent.putExtra("Name",mylists.get(position).getTecharName());
                    activity.startActivity(intent);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private Button buttonuserid,btadd ,btviewfilestudent;
       // textTitle,textHeader,textSubtitle
        ...
        public ViewHolder(@NonNull View itemView) {
           ...
           txv_job_title = itemView.findViewById(R.id.textTitle);
            ...
            btviewfilestudent= itemView.findViewById(R.id.btviewfilestudent);
