...
public class AdapterEmoplay extends RecyclerView.Adapter<AdapterEmoplay.ViewHolder> {
    private List<Student>mylists;
   // private ProductFragment productFragment;
   // private ProductPageByCategoryFragment productPageByCategoryFragment;
    private Context activity;

    public AdapterEmoplay(List<Student> mylists) {
        this.mylists = mylists;
    }

    public AdapterEmoplay(List<Student> mylists, Context activity) {
        this.mylists = mylists;
    ...
    @NonNull
    @Override
    public AdapterEmoplay.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterEmoplay.ViewHolder holder, int position) {
